            ...
            <div style="max-width: 1320px; margin: 0 auto; padding: 0 clamp(1rem, 5vw, 3rem);">
                ...
                <div style="position: relative; border-radius: 32px; overflow: hidden; background-color: #0c0b0a; background-image: radial-gradient(rgba(255,255,255,0.06) 1px, transparent 1px); background-size: 18px 18px; padding: 4.5rem 4rem 2.5rem 4rem; box-shadow: 0 25px 60px rgba(0,0,0,0.35);">
                    ...
                    <div class="responsive-grid-footer" style="display: grid; gap: 3.5rem; margin-bottom: 3.8rem; align-items: start;">
                        ...
                        <!-- Column 4: Service Times, Social Icons & Embedded Map -->
                        <div>
                            ...
                            <div style="font-family: 'Instrument Sans', sans-serif; font-size: 0.9rem; color: #d6d3d1; margin-bottom: 1.5rem; line-height: 1.7;">
                                <p style="margin: 0 0 0.5rem 0;"><strong style="color: #ffffff;">Sunday Worship:</strong> 9:00 AM - 11:00 AM</p>
                                <p style="margin: 0;"><strong style="color: #ffffff;">Bible Study &amp; Rosary:</strong> Wednesday - 6:30 PM</p>
                            </div>

                            <!-- Social Media Icons ÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½ SVG, white on dark -->
                            ...
                            <div style="border-radius: 14px; overflow: hidden; height: 110px; border: 1px solid rgba(255,255,255,0.12); box-shadow: 0 6px 16px rgba(0,0,0,0.3);">
