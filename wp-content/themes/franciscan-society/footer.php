            ...
            <div style="max-width: 1320px; margin: 0 auto; padding: 0 clamp(1rem, 5vw, 3rem);">
                ...
                <div class="footer-main-card" style="position: relative; border-radius: 32px; overflow: hidden; background-color: #0c0b0a; background-image: radial-gradient(rgba(255,255,255,0.06) 1px, transparent 1px); background-size: 18px 18px; padding: 4.5rem 4rem 2.5rem 4rem; border: 1px solid rgba(230, 200, 136, 0.18); box-shadow: 0 -12px 35px rgba(12, 11, 10, 0.25), 0 25px 60px rgba(0,0,0,0.45);">
                    ...
                    <div class="responsive-grid-footer" style="display: grid; gap: 3.5rem; margin-bottom: 3.8rem; align-items: start;">
                        ...
                        <div class="footer-col-brand" style="text-align: start;">
                            <?php
                            ...
                            <div class="footer-contact-list" style="display: flex; flex-direction: column; gap: 1.1rem; font-family: 'Instrument Sans', sans-serif; font-size: 0.92rem; color: #d6d3d1; text-align: start; width: 100%;">
                                <div class="footer-contact-item" style="display: flex; align-items: center; gap: 0.8rem; text-align: start; width: 100%;">
                                    <span class="footer-contact-icon" style="width: 36px; height: 36px; border-radius: 50%; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.18); display: flex; align-items: center; justify-content: center; color: #ffffff; flex-shrink: 0;">
                                ...
                                <div class="footer-contact-item is-address" style="display: flex; align-items: flex-start; gap: 0.8rem; margin-top: 0.3rem; text-align: start; width: 100%;">
                                    <span class="footer-contact-icon" style="width: 36px; height: 36px; border-radius: 50%; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.18); display: flex; align-items: center; justify-content: center; color: #ffffff; flex-shrink: 0;">
                                    ...
                                    <span class="footer-address-text" style="line-height: 1.5; font-size: 0.88rem; text-align: start; display: block; flex: 1 1 auto; min-width: 0; margin: 0; padding: 0;"><?php echo nl2br( esc_html( $footer_address ) ); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.95rem; font-family: 'Instrument Sans', sans-serif; font-size: 0.92rem;">
                                ...
                                <li><a href="<?php echo esc_url( franciscan_resolve_nav_url( franciscan_get_option( 'nav_link_about', '/about/' ), '/about/' ) ); ?>" style="color: #a8a29e; text-decoration: none; transition: color 0.3s ease;" onmouseover="this.style.color='#e6c888'" onmouseout="this.style.color='#a8a29e'"><?php echo esc_html( franciscan_get_option( 'nav_label_about', 'About Us' ) ); ?></a></li>
                                ...
                                <?php
                                $is_blogs_hidden_footer = ( '1' === (string) franciscan_get_page_field( 'blogs', 'hide_blogs_page', '0' ) ) || ( '1' === (string) get_option( 'franciscan_hide_blogs_page', '0' ) );
                                if ( ! $is_blogs_hidden_footer ) :
                                ?>
                                <li><a href="<?php echo esc_url( franciscan_resolve_nav_url( franciscan_get_option( 'nav_link_blogs', '/blogs/' ), '/blogs/' ) ); ?>" style="color: #a8a29e; text-decoration: none; transition: color 0.3s ease;" onmouseover="this.style.color='#e6c888'" onmouseout="this.style.color='#a8a29e'"><?php echo esc_html( franciscan_get_option( 'nav_label_blogs', 'Blog & Reflections' ) ); ?></a></li>
                                <?php endif; ?>
                        ...
                        <div>
                            ...
                            <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.95rem; font-family: 'Instrument Sans', sans-serif; font-size: 0.92rem;">
                                ...
                                <li><a href="<?php echo esc_url( franciscan_resolve_nav_url( franciscan_get_option( 'nav_link_ministries_formation', '/ministries-formation/' ), '/ministries-formation/' ) ); ?>" style="color: #a8a29e; text-decoration: none; transition: color 0.3s ease;" onmouseover="this.style.color='#e6c888'" onmouseout="this.style.color='#a8a29e'"><?php echo esc_html( franciscan_get_option( 'nav_label_ministries_formation', 'Formation Ministry' ) ); ?></a></li>
                                <li><a href="<?php echo esc_url( franciscan_resolve_nav_url( franciscan_get_option( 'nav_link_ministries_education', '/ministries-education/' ), '/ministries-education/' ) ); ?>" style="color: #a8a29e; text-decoration: none; transition: color 0.3s ease;" onmouseover="this.style.color='#e6c888'" onmouseout="this.style.color='#a8a29e'"><?php echo esc_html( franciscan_get_option( 'nav_label_ministries_education', 'Education Ministry' ) ); ?></a></li>
