            ...
            if ( empty( $saved ) || ! is_array( $saved ) ) {
                ...
                if ( 'community-leadership' === $slug ) {
                    ...
                    if ( empty( $clean['card_subtitle'] ) || 'Led by the Minister Provincial and provincial leadership team committed to spiritual excellence.' === $clean['card_subtitle'] ) {
                        $clean['card_subtitle'] = '"We must never desire to be above others, but, instead, we must be servants and subject to every human creature for God’s sake." Francis of Assisi, Letter to the Faithful';
                    }
                    if ( empty( $clean['hero_subtitle'] ) ) {
                        $clean['hero_subtitle'] = 'Guiding the Province in fraternity, governance, and mission.';
                    }
                }
