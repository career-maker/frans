<?php
/**
 * Template Name: Ministries - Pastoral
 *
...
<main id="main-content" style="padding-top: 0; background-color: #FFFFFF;">
    ...
    ?>
    <section class="page-hero-banner" style="background-image: url('<?php echo esc_url( $pastoral_hero_bg ); ?>'); background-size: cover; background-position: center; position: relative; overflow: hidden;">
        ...
        <div style="max-width: 1320px; margin: 0 auto; padding: 0 clamp(1rem, 5vw, 3rem); position: relative; z-index: 2; text-align: left;">
            <?php if ( ! empty( $pastoral_hero_badge ) ) : ?>
            <div style="display: inline-flex; align-items: center; gap: 0.6rem; background: rgba(255,255,255,0.1); backdrop-filter: blur(10px); padding: 0.5rem 1.2rem; border-radius: 50px; margin-bottom: 1.5rem; border: 1px solid rgba(255,255,255,0.2); font-style: italic;">
                ...
                <span style="color: #ffffff; font-size: 0.85rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.08em; font-family: 'Instrument Sans', sans-serif;"><?php echo esc_html( $pastoral_hero_badge ); ?></span> 
            </div>
            <?php endif; ?>
            <?php if ( ! empty( $pastoral_hero_title ) ) : ?>
            <h1 style="font-family: 'Phudu', sans-serif; font-size: clamp(1.4rem, 2.6vw, 2.25rem); font-weight: 700; color: #ffffff; text-transform: uppercase; margin: 0 0 1rem 0; line-height: 1.2; text-align: left;"><?php echo franciscan_render_rich_text( $pastoral_hero_title ); ?></h1>
            <?php endif; ?>
            <?php if ( ! empty( $pastoral_hero_desc ) ) : ?>
            <p style="font-family: 'Instrument Sans', sans-serif; font-size: clamp(1rem, 1.8vw, 1.18rem); color: rgba(255, 255, 255, 0.92); max-width: 820px; margin: 0.8rem 0 0 0; line-height: 1.6; font-style: italic; text-align: left;">
                <?php echo franciscan_render_rich_text( $pastoral_hero_desc ); ?>
            </p>
            <?php endif; ?>
        </div>
    </section>
    ...
    <section style="padding: clamp(3.5rem, 6vw, 6rem) 0; background: #FFFFFF; color: #1c1917;">
        <div style="max-width: 1240px; margin: 0 auto; padding: 0 clamp(1rem, 4vw, 2.5rem);">
            ...
            <div style="display: grid; grid-template-columns: 1.1fr 0.9fr; gap: clamp(2.5rem, 5vw, 4.5rem); align-items: center; margin-bottom: clamp(3.5rem, 6vw, 5.5rem);" class="responsive-ministry-grid">
                <div>
                    <h2 style="font-family: 'Phudu', sans-serif; font-size: clamp(2rem, 3.2vw, 2.6rem); font-weight: 700; color: #1c1917; text-transform: uppercase; line-height: 1.2; margin: 0 0 1.5rem 0;">
                ...
                <div style="border-radius: 20px; overflow: hidden; box-shadow: 0 15px 40px rgba(74,42,24,0.12); border: 2px solid rgba(230,200,136,0.3); background: #FAF7F0;">
                    ...
                    ?>
                    <img loading="lazy" decoding="async" src="<?php echo esc_url( $pastoral_img1 ); ?>" alt="<?php echo esc_attr( franciscan_get_page_field( "ministries-pastoral", "section_1_img_alt", "Pastoral Ministry in Parishes" ) ); ?>" style="width: 100%; height: 460px; object-fit: cover; display: block; transition: transform 0.5s ease;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 0.9fr 1.1fr; gap: clamp(2.5rem, 5vw, 4.5rem); align-items: center;" class="responsive-ministry-grid">
                <div style="border-radius: 20px; overflow: hidden; box-shadow: 0 15px 40px rgba(74,42,24,0.12); border: 2px solid rgba(230,200,136,0.3); background: #FAF7F0;">
                    ...
                    ?>
                    <img loading="lazy" decoding="async" src="<?php echo esc_url( $pastoral_img2 ); ?>" alt="<?php echo esc_attr( franciscan_get_page_field( "ministries-pastoral", "section_2_img_alt", "Pastoral Presence in Communities" ) ); ?>" style="width: 100%; height: 460px; object-fit: cover; display: block; transition: transform 0.5s ease;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
                </div>
