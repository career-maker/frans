...
<main id="main-content" style="padding-top: 0; background-color: #FFFFFF;">    <!-- Page Hero Section -->
    ...
    ?>
    <section class="page-hero-banner" style="background-image: url('<?php echo esc_url( $comm_hero_bg ); ?>'); background-size: cover; background-position: center; position: relative; overflow: hidden;">
