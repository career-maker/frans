...
<main id="main-content" style="padding-top: 0; background-color: #FFFFFF;">    <!-- Page Hero Section -->
    ...
    $comm_hero_title = franciscan_get_page_field( 'community', 'hero_title', 'COMMUNITY', false );
    if ( empty( trim( $comm_hero_title ) ) ) {
    ...
    <section class="page-hero-banner" style="padding: 12rem 2rem 8rem 2rem; background-image: url('<?php echo esc_url( $comm_hero_bg ); ?>'); background-size: cover; background-position: center; position: relative; overflow: hidden;">
        ...
        <div style="max-width: 1320px; margin: 0 auto; padding: 0 clamp(1rem, 5vw, 3rem); position: relative; z-index: 2; text-align: left;">
            ...
            <div style="display: inline-flex; align-items: center; gap: 0.6rem; background: rgba(255,255,255,0.1); backdrop-filter: blur(10px); padding: 0.5rem 1rem; border-radius: 50px; margin-bottom: 1.5rem; border: 1px solid rgba(255,255,255,0.2);">
                ...
                <span style="color: #ffffff; font-size: 0.85rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.08em; font-family: 'Instrument Sans', sans-serif;"><?php echo esc_html( $comm_hero_badge ); ?></span>
            </div>
            <?php endif; ?>
            <?php if ( ! empty( $comm_hero_title ) ) : ?>
            <h1 style="font-family: 'Phudu', sans-serif; font-size: clamp(1.4rem, 2.6vw, 2.25rem); font-weight: 700; color: #ffffff; text-transform: uppercase; margin: 0 0 1rem 0; line-height: 1.2; text-align: left;"><?php echo esc_html( $comm_hero_title ); ?></h1>
            <?php endif; ?>
            <?php if ( ! empty( $comm_hero_sub ) ) : ?>
                <p style="font-family: 'Instrument Sans', sans-serif; font-size: clamp(1rem, 1.8vw, 1.18rem); color: rgba(255, 255, 255, 0.92); max-width: 760px; margin: 0.8rem 0 0 0; line-height: 1.6; font-weight: 400; text-align: left;">
                    <?php echo nl2br( esc_html( $comm_hero_sub ) ); ?>
                </p>
            <?php endif; ?>
        </div>
    </section>
