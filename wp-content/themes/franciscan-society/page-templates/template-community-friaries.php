...
<main id="main-content" style="padding-top: 0; background-color: #FFF;">
    ...
    $friaries_hero_title = franciscan_get_page_field( 'community-friaries', 'hero_title', 'OUR FRIARIES & ASHRAMS', false );
    if ( empty( trim( $friaries_hero_title ) ) ) {
        $friaries_hero_title = 'OUR FRIARIES & ASHRAMS';
    }
    ...
    <section class="page-hero-banner" style="padding: 12rem 2rem 8rem 2rem; background-image: url('<?php echo esc_url( $friaries_hero_bg ); ?>'); background-size: cover; background-position: center; position: relative; overflow: hidden;">
        <div class="hero-overlay page-hero-overlay" style="position: absolute; inset: 0; background-color: rgba(12, 11, 10, 0.7);"></div>
        <div style="max-width: 1320px; margin: 0 auto; padding: 0 clamp(1rem, 5vw, 3rem); position: relative; z-index: 2; text-align: left;">
            ...
            <h1 style="font-family: 'Phudu', sans-serif; font-size: clamp(1.4rem, 2.6vw, 2.25rem); font-weight: 700; color: #ffffff; text-transform: uppercase; margin: 0 0 1rem 0; line-height: 1.2; text-align: left;"><?php echo franciscan_render_rich_text( $friaries_hero_title ); ?></h1>
            <?php endif; ?>
            <?php if ( ! empty( $friaries_hero_desc ) ) : ?>
                <p style="font-family: 'Instrument Sans', sans-serif; font-size: clamp(1rem, 1.8vw, 1.18rem); color: rgba(255, 255, 255, 0.92); max-width: 760px; margin: 0.8rem 0 0 0; line-height: 1.6; font-weight: 400; text-align: left; font-style: italic;">
                    <?php echo franciscan_render_rich_text( $friaries_hero_desc ); ?>
                </p>
            <?php endif; ?>
        </div>
    </section>
