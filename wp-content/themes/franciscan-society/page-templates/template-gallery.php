    ...
    <section class="page-hero-banner" style="position: relative; padding-top: 180px; padding-bottom: 120px; background: url('<?php echo esc_url( $gal_hero_bg ); ?>') center/cover no-repeat;">
        ...
        <div style="position: relative; z-index: 10; max-width: 1320px; margin: 0 auto; padding: 0 clamp(1rem, 5vw, 3rem); text-align: left;">
            <?php if ( ! empty( $gal_hero_badge ) ) : ?>
                <div style="display: inline-block; padding: 0.35rem 1.1rem; background: rgba(230, 200, 136, 0.18); border: 1px solid rgba(230, 200, 136, 0.4); border-radius: 50px; font-family: 'Instrument Sans', sans-serif; font-size: 0.85rem; font-weight: 700; color: #e6c888; letter-spacing: 0.12em; text-transform: uppercase; margin-bottom: 0.85rem; font-style: italic;">
            ...
            <?php if ( ! empty( $gal_hero_sub ) ) : ?>
                <div style="font-family: 'Instrument Sans', sans-serif; font-size: 1.05rem; font-weight: 600; color: #e7e2d6; text-align: left; max-width: 800px; font-style: italic;">
