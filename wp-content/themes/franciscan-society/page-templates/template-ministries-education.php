...
<main id="main-content" style="padding-top: 0; background-color: #FFFFFF;">
    <!-- Page Hero -->
    <section style="padding: 11rem 2rem 7rem 2rem; background-image: url('<?php echo esc_url( franciscan_get_page_field( "ministries-education", "hero_image", FRANCISCAN_THEME_URI . "/assets/images/new_uploads/ChatGPT_Image_Aug_18_2026_05_51_30_PM.png" ) ); ?>'); background-size: cover; background-position: center; position: relative; overflow: hidden;">
