<?php
/**
 * Template Name: Ministries - Education
 *
...
<main id="main-content" style="padding-top: 0; background-color: #FFFFFF;">
    <?php
    $edu_hero_bg = franciscan_get_page_field( 'ministries-education', 'hero_image', '' );
    if ( empty( $edu_hero_bg ) || false !== strpos( $edu_hero_bg, 'ChatGPT_Image' ) ) {
        $edu_hero_bg = FRANCISCAN_THEME_URI . '/assets/images/new_uploads/education-ministry-banner.jpg';
    }
    ?>
    <section style="padding: 11rem 2rem 7rem 2rem; background-image: url('<?php echo esc_url( $edu_hero_bg ); ?>'); background-size: cover; background-position: center; position: relative; overflow: hidden;">
        ...
        <div style="max-width: 900px; margin: 0 auto; position: relative; z-index: 2; text-align: center;">
            <h1 style="font-family: 'Phudu', sans-serif; font-size: clamp(2.8rem, 5.2vw, 4.5rem); font-weight: 700; color: #ffffff; text-transform: uppercase; margin: 0 0 1rem 0; line-height: 1.1;"><?php echo esc_html( franciscan_get_page_field( "ministries-education", "hero_title", "EDUCATION MINISTRY" ) ); ?></h1>
            <p style="font-family: 'Instrument Sans', sans-serif; font-size: clamp(1rem, 1.8vw, 1.18rem); color: rgba(255, 255, 255, 0.92); max-width: 820px; margin: 0.8rem auto 0; line-height: 1.6; font-style: italic;">
                <?php echo nl2br( esc_html( franciscan_get_page_field( "ministries-education", "hero_subtitle", "“Where there is charity and wisdom, there is neither fear nor ignorance.”" ) ) ); ?>
            </p>
        </div>
    </section>

    <!-- Main Content: 2-Section Paragraph UI with Images -->
    <section style="padding: clamp(3.5rem, 6vw, 6rem) 0; background: #FFFFFF; color: #1c1917;">
        <div style="max-width: 1240px; margin: 0 auto; padding: 0 clamp(1rem, 4vw, 2.5rem);">
            
            <!-- Section 1 -->
            <div style="display: grid; grid-template-columns: 1.1fr 0.9fr; gap: clamp(2.5rem, 5vw, 4.5rem); align-items: center; margin-bottom: clamp(3.5rem, 6vw, 5.5rem);" class="responsive-ministry-grid">
                <div>
    ...
    <style>
        @media (max-width: 900px) {
            ...
            .responsive-ministry-grid:nth-child(2) > div:first-child {
                order: 2 !important;
            }
            .responsive-ministry-grid:nth-child(2) > div:last-child {
                order: 1 !important;
            }
        }
    </style>
