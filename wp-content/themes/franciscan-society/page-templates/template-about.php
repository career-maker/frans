...
<main id="main-content" style="padding-top: 0; background-color: #FFFFFF;">
    ...
    ?>
    <section class="page-hero-banner" style="background-image: url('<?php echo esc_url( $about_hero_bg ); ?>'); background-size: cover; background-position: center; position: relative; overflow: hidden;">
        ...
        <div style="max-width: 1320px; margin: 0 auto; padding: 0 clamp(1rem, 5vw, 3rem); position: relative; z-index: 2; text-align: left;">
            ...
            <h1 style="font-family: 'Phudu', sans-serif; font-size: clamp(1.4rem, 2.6vw, 2.25rem); font-weight: 700; color: #ffffff; text-transform: uppercase; margin: 0 0 1rem 0; line-height: 1.2; text-align: left;"><?php echo franciscan_render_rich_text( $about_hero_title ); ?></h1>
            <?php endif; ?>
            <?php if ( ! empty( $about_hero_desc ) ) : ?>
                <p style="font-family: 'Instrument Sans', sans-serif; font-size: clamp(1rem, 1.8vw, 1.18rem); color: rgba(255, 255, 255, 0.92); max-width: 760px; margin: 0.8rem 0 0 0; line-height: 1.6; font-weight: 400; text-align: left; font-style: italic;">
                    <?php echo franciscan_render_rich_text( $about_hero_desc ); ?>
                </p>
            <?php endif; ?>
        </div>
    </section>
                ...
                <div class="gsap-fade-up">
                    ...
                    <div style="border-radius: 16px; padding: 2.5rem; display: flex; gap: 2rem; position: relative; margin-bottom: 3rem;">
                        ...
                        <div style="flex: 1; padding-left: 1rem;">
                            <h4 style="font-family: 'Phudu', sans-serif; font-size: 1.3rem; font-weight: 700; text-transform: uppercase; margin-bottom: 0.8rem; color: #1c1917;"><?php echo esc_html( franciscan_get_page_field( 'about', 'prayer_support_title', 'FAITH & TRUST' ) ); ?></h4>
                            <p style="font-family: 'Instrument Sans', sans-serif; font-size: 0.95rem; color: #78716c; line-height: 1.5; margin: 0;"><?php echo esc_html( franciscan_get_page_field( 'about', 'prayer_support_desc', 'We place our faith in God and trust His guidance in every aspect of our ministry.' ) ); ?></p>
                        </div>
                        <div style="width: 1px; background-color: #e7e5e4;"></div>
                        <div style="flex: 1;">
                            <h4 style="font-family: 'Phudu', sans-serif; font-size: 1.3rem; font-weight: 700; text-transform: uppercase; margin-bottom: 0.8rem; color: #1c1917;"><?php echo esc_html( franciscan_get_page_field( 'about', 'fellowship_title', 'LOVE & COMPASSION' ) ); ?></h4>
                            <p style="font-family: 'Instrument Sans', sans-serif; font-size: 0.95rem; color: #78716c; line-height: 1.5; margin: 0;"><?php echo esc_html( franciscan_get_page_field( 'about', 'fellowship_desc', 'We serve others with genuine love, kindness, compassion, and a heart for those in need.' ) ); ?></p>
                        </div>
                    </div>
