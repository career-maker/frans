...
<main id="main-content" style="padding-top: 0; background-color: #FFFFFF;">
    ...
    $prologue_subtitle = franciscan_get_page_field( 'community-rule', 'prologue_subtitle', 'The Beginning of the Rule and the Life of the Brothers and Sisters of the Third Order Regular of St. Francis' );
    ...
    <section class="page-hero-banner" style="padding: 11rem 2rem 6.5rem 2rem; background-image: url('<?php echo esc_url( $rule_hero_bg ); ?>'); background-size: cover; background-position: center; position: relative; overflow: hidden;">
        <div class="hero-overlay page-hero-overlay" style="position: absolute; inset: 0; background: linear-gradient(180deg, rgba(12, 11, 10, 0.78) 0%, rgba(12, 11, 10, 0.65) 100%);"></div>
        ...
        <div style="max-width: 960px; margin: 0 auto;">
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 2rem; align-items: flex-start; justify-content: space-between; margin-bottom: 1.5rem;">
                ...
                <div style="flex: 1 1 580px; min-width: 290px;">
                    ...
                    <?php if ( ! empty( $prologue_subtitle ) ) : ?>
